...
const DescriptionBox = () => {
  return (
    <div className='descriptionBox'>
      ...
      <div className="descripionbox-description">
        ...
        <p>E-commerce websites typically display products or services a detailed descriptions, images, prices, and any available var
              (e.g., sizes, colors). Each product usually has its own dedi with relevant information. </p>
      </div>
    </div>
  );
};
